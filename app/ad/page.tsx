"use client";
// Ad maker landing: create (9-beat preset | empty) + topic (free text or trend pick)
  ...
  return (
    <main className="mx-auto w-full max-w-[1280px] grow px-5 py-6">
      <header className="mb-6 flex items-center justify-between">
        ...
        <Link href="/" className="rounded-md border border-border bg-surface px-3 py-1.5 text-sm font-medium text-muted transition-colors duration-200 hover:border-empathy hover:text-ink">
          ← 비교 숏폼
        </Link>
      </header>
